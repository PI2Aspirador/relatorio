...
\subsection{Controle} % (fold)
	...
	\subsubsection{Formas de controle de Sistemas}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.5]{figuras/diagrama_blocos_controle.png}
		...
		\subsubsection{Sistema de Controle do R2-PI2}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[scale=0.6]{figuras/diagrama_blocos_R2PI2.png}
			...
			\begin{enumerate}
				\item \textbf{Ponte H}:
					...
					\begin{figure}[H]
						\centering
						\includegraphics[scale=0.6]{figuras/configH.png}
