...
O planejamento financeiro do projeto leva em consideração o custo de aquisição dos materiais necessários para desenvolvimento da solução proposta, assim como a estratégia de recolhimento do orçamento necessário. Como a solução proposta está dividida em sub-sistemas, utilizou-se da mesma lógica para determinar o custo dos materiais. O sub-sistema referente a solução de software não possui custo, já que não será necessária a aquisição de nenhum componente.

Na tabela \ref{tab:custo_eletronica} estão dispostos os componentes, o preço dos mesmos, a quantidade necessária e o preço total.
