...
\label{sec:sensoriamento2}
	...
	\label{sub:instrumentação2}
		...
		O disco utilizado tem 20 furos, o que significa que a sua resolução é de 9 $\circ $, com ele é possível enviar comando de giro e verificar se o robô está girando essa quantidade de graus.
